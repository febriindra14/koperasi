...
class AuthController extends Controller
{
    ...
    public function login()
    {
        ...
        if ($this->auth->check()) {
            ...
            $redirectURL = session('redirect_url') ?? site_url('/cek-dashboard') ??   site_url('/');
        ...
        $_SESSION['redirect_url'] = session('redirect_url') ??  site_url('/cek-dashboard') ?? site_url('/');
    ...
    public function register()
    {
        ...
        if ($TaAktif != '1') {
            return redirect()->to('/daftar-sekarang');
        }
    ...
    public function attemptRegister()
    {
        ...
        // save to Santri
        $select = $this->request->getVar('jenjang_id');
        if ($select == '1') { //mts putra
            $gender = 'Laki-Laki';
            $jenjang = '1';
        } elseif ($select == '2') {
            $gender = 'Perempuan';
        ...
        $santriModel->insert([
            'nik'   => $this->request->getVar('username'),
            'ref_jenjang_id'   => $jenjang,
            'gender' => $gender,
            'step' => 0
        ]);
