    ...
    <div id="button-trigger" class="card card-default scrollspy">
      <div class="card-content">
        <div class="row">
          ...
          <div class="col l2 m2">
            <a href="<?= url_to('tambah-bidang-usaha'); ?>" class="btn" style=" background : linear-gradient(45deg, indigo, blue)">Tambah Bidang Usaha</a>
          </div>
        </div>
        <div class="row">
          <div class="col s12">
                        ...
                        <tr>
                          ...
                          <td>
                            <a data-position="top" data-tooltip="Edit Data" class="tooltipped btn-floating mb-1 btn-flat waves-effect amber darken-2 white-text"
                             href="<?=base_url('/'); ?>/admin/edit-bidang-usaha/<?= $isi->id_posts?>" data-target="dropdown2">
                            ...
                            href="<?= base_url('/')?>/admin/delete-bidang-usaha/<?= $isi->id_posts?>" data-target="dropdown2">
