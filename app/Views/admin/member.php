    ...
    <div id="button-trigger" class="card card-default scrollspy">
      <div class="card-content">
        <div class="row">
          ...
          <div class="col l2 m2">
            <a href="<?= url_to('tambah-member'); ?>" class="btn" style=" background : linear-gradient(45deg, indigo, blue)">Tambah Member</a>
          </div>
        </div>
        <div class="row">
          <div class="col s12">
                  ...
                  <table id="data-table-tanggal" class="display dataTable dtr-inline" role="grid" style="width:100%">
                    ...
                    <tbody>
                      <?php foreach ($member as $row) : ?>
                        <tr>
                          <td><span class="avatar-contact avatar-online"><img style="max-height: 100px;" src="<?= base_url('public/img/' . $row->foto); ?>" alt="avatar"></span></td>
                          <td style="text-transform: uppercase;"><?= $row->nama_pengurus; ?></td>
                          <td><?= $row->jabatan; ?></td>
                          <td>
